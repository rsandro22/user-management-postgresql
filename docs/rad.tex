...
Svaki audit zapis sadrži informaciju o vrsti događaja i vremenu izvršenja, čime se omogućuje naknadna analiza aktivnosti. Takav pristup povećava transparentnost rada sustava i predstavlja dobru praksu u razvoju aplikacija koje upravljaju korisničkim računima \cite{behl2017cybersecurity}.
